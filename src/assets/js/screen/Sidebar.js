...
const Sidebar = {
    render: async () =>{
        ...
        <ul>
          ...
          <li>
            <a href="/#/products" class="sidebar_link ${(request.resource === 'products')?'active':''}">
              <div class="icon">
                <svg
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <li>
            <a href="#/customers" class="sidebar_link ${(request.resource === 'customers')?'active':''}">
              <div class="icon">
                <svg
                  fill="currentColor"
                  viewBox="0 0 24 24"
          ...
          <li>
            <a href="#/orders" class="sidebar_link">
              <div class="icon">
                <svg
                  fill="currentColor"
                  viewBox="0 0 24 24"
        ...
        <div class="compact" id="sb_compact">Thu gọn</div>
      </div>`
    },after_render: ()=>{
        const compact = document.getElementById('sb_compact');
